...
import Dog from './img/Men1.gif'
import Cat from './img/women1.gif'
import Rat from './img/kid1.gif'
import Mat from './img/other1.gif'
                    ...
                    <div className="row">
                        ...
                        <div className="column">
                            ...
                            <div className="flip-card">
                                <div className="flip-card-inner">
                                    <div className="flip-card-front">
                                    <img src={Dog} alt="Avatar" style={{width:'100%', height:'100%'}}/>
                                    </div>
                                    <div className="flip-card-back1">
                                        <br/><br/><br/><br/><br/><br/><br/>
                                        <h1>Men's Collection</h1>
                        ...
                        <div className="column">
                            ...
                            <div className="flip-card">
                                <div className="flip-card-inner">
                                    <div className="flip-card-front">
                                    <img src={Cat} alt="Avatar" style={{width:'100%', height:'100%'}}/>
                                    </div>
                                    <div className="flip-card-back2">
                                        <br/><br/><br/><br/><br/><br/><br/>
                                        <h1>Women's Collection</h1>
                        ...
                        <div className="column">
                            ...
                            <div className="flip-card">
                                <div className="flip-card-inner">
                                    <div className="flip-card-front">
                                    <img src={Rat} alt="Avatar" style={{width:'100%', height:'100%'}}/>
                                    </div>
                                    <div className="flip-card-back3">
                                        <br/><br/><br/><br/><br/><br/><br/>
                                        <h1>Kid's Collection</h1>
                       ...
                       <div className="column">
                            ...
                            <div className="flip-card">
                                <div className="flip-card-inner">
                                    <div className="flip-card-front">
                                    <img src={Mat} alt="Avatar" style={{width:'100%', height:'100%'}}/>
                                    </div>
                                    <div className="flip-card-back4">
                                        <br/><br/><br/><br/><br/><br/><br/>
                                        <h1>Other Collection</h1>
